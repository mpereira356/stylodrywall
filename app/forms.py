...
from wtforms import StringField, PasswordField, TextAreaField, DecimalField, SelectField, SubmitField, BooleanField
from wtforms.validators import DataRequired, Email, Length, Optional, NumberRange

class LoginForm(FlaskForm):
    username=StringField("Usuário",validators=[DataRequired(),Length(min=3,max=180)]); password=PasswordField("Senha",validators=[DataRequired()]); remember=BooleanField("Manter conectado neste dispositivo"); submit=SubmitField("Entrar no painel")
